...
IF (PNETCDF_INCLUDE_DIR)
  ...
  FIND_LIBRARY(MFHDF_LIBRARY     mfhdf    PATHS ${HDF_DIR}/lib ${HDF4_DIR}/lib NO_DEFAULT_PATH)
  FIND_LIBRARY(MFHDF_LIBRARY     mfhdf    )
  FIND_LIBRARY(DF_LIBRARY        df       PATHS ${HDF_DIR}/lib ${HDF4_DIR}/lib NO_DEFAULT_PATH)
  FIND_LIBRARY(DF_LIBRARY        df       )
